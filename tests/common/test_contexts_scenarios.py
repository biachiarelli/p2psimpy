...
from goald.quality.common.pragmatic.pragmatic_planning import PragmaticPlanning
import pytest
...
def test_C1(mpers):
    ...
    plan2 = PragmaticPlanning().isAchievable(mpers.rootGoal, fullContext, None)
    ...
    assert False is assertPlan(
        plan2, [mpers.tasks.accessLocationFromGPSTask, mpers.tasks.centralCallTask])
...
def test_C2(mpers):
    ...
    tasks2 = PragmaticPlanning().isAchievable(mpers.rootGoal, fullContext, None)
